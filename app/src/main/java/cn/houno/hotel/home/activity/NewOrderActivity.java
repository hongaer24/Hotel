...
import cn.houno.hotel.ui.activity.bookmanager.adapter.CountryListAdapter;
import cn.houno.hotel.ui.activity.bookmanager.adapter.RoomRateAdapter;
...
public class NewOrderActivity extends BaseActivity {
  ...
  /*  @Bind(R.id.tv_room_count)
   ...
   /* @Bind(R.id.tv_room_type)
    TextView tvRoomType;*/
    @Bind(R.id.tv_room_type1)
    TextView tvRoomType1;
    @Bind(R.id.iv_number_person)
    ImageView ivNumberPerson;
    @Bind(R.id.tv_rate_code1)
    TextView tvRateCode1;
    @Bind(R.id.iv_rate_code)
    ImageView ivRateCode;
    @Bind(R.id.tv_package1)
    TextView tvPackage1;
    @Bind(R.id.iv_package)
    ImageView ivPackage;
  ...
  /*  @Bind(R.id.tv_country)
    ...
    * */
    ...
    private void showPeopleNumberDialog() {
        ...
        view.findViewById(R.id.tv_confirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              tvPeopleCount.setText(String.valueOf(mPersonCount));
            }
        });
    ...
    private void showRoomTypeDialog() {
        ...
        showDialog("房型", new RoomTypeCodeAdapter(mActivity, mRoomTypeCodeList), new OnItemClickListener() {
            ...
            public void OnItemClickListener(int position) {
                ...
                tvRoomType1.setText(mRoomTypeName);

                //清空套餐和房价码
                mPackageList.clear();
                tvPackage1.setText("请选择套餐");
                mRoomRateList.clear();
                tvRateCode1.setText("请选择房价码");
                tvPrice.setText("");
            }
        });
    }
    ...
    private void showPackageCodeDialog() {
        showDialog("套餐", new RoomPriceCodeAdapter(mActivity, mPackageList), new OnItemClickListener() {
            ...
            public void OnItemClickListener(int position) {
                ...
                tvPackage1.setText(mPackageName);
    ...
    @OnClick({R.id.iv_back, R.id.iv_contract, R.id.tv_country, R.id.tv_province, R.id.tv_city, R.id.tv_arr_date
            , R.id.tv_lea_date,/* R.id.tv_lea_time,*/ R.id.tv_room_count, R.id.tv_people_count
            , R.id.tv_room_type1, R.id.tv_package1, R.id.tv_rate_code1, R.id.btn_submit_order})
