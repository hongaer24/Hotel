...
public class SearchBillsAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<SearchBillsBean.InfoBean> mList;

    public SearchBillsAdapter(Context context, List<SearchBillsBean.InfoBean> list) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvRoomCode.setText(Html.fromHtml("房号：<font color='#838281'>" + mList.get(position).getRoomidcode() + "</font>"));
        holder.tvRoomName.setText(Html.fromHtml("房间简称：<font color='#838281'>" + mList.get(position).getRoomname()+"</font>"));
        ...
        String oldRoomStateCode = mList.get(position).getSys_roomstatecode();
        String newRoomStateCode = mList.get(position).getNewroomstatecode();
