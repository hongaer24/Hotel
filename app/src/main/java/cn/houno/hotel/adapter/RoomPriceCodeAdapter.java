...
public class RoomPriceCodeAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<RoomPriceCodeListBean.InfoBean> mList;

    public RoomPriceCodeAdapter(Context context, List<RoomPriceCodeListBean.InfoBean> list) {
        mContext = context;
